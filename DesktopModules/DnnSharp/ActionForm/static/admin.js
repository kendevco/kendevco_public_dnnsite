...
(function (angular) {
    ...
    function FormCtrl($scope, $http, sharedData, $timeout, $sce, dnnsf, dnnsfHttp, $interpolate, $rootScope) {
        ...
        function prepareSettings() {
            ...
            if (sharedData.form.FormTemplate && sharedData.form.FormTemplate.Value) {
                $rootScope.uiLibrary = sharedData.form.FormTemplate.Value;
            }
        ...
        $scope.prepareFields = function (fields) {
            ...
            $.each(fields, function (i, field) {
                field.isObsolete = "IsObsolete" in field.Parameters;
        ...
        function loadForm() {
            ...
            dnnsfHttp(dnnsf.moduleId, {
                ...
                dnnsf.promiseResponse('GET', dnnsf.adminApi('TestFlush'), $.ServicesFramework)
                    .then(function (xhr) {
        ...
        $scope.computeName = function (field) {
            ...
            if (!field.AutoName) {
                ...
                if (field.BoundName !== '' && field.BoundName.match(/^[a-z][a-z0-9_]*$/i)) {
                    ...
                    $scope.saveDisabled = _.some(invalidFields, function (value) {
                        return value;
                    });
        ...
        $scope.addButton = function () {
            $scope.addField($scope.fieldDefs['button']);
        }
        ...
        $scope.exportFields = function () {
            var fieldsString = JSON.stringify(cleanFormFields(sharedData.form.Fields), null, 4);
    ...
    FormCtrl.$inject = ['$scope', '$http', 'sharedData', '$timeout', '$sce', 'dnnsf', 'dnnsfHttp', '$interpolate', '$rootScope'];
        ...
        $(document).on('click', 'a[href*="#"]', function () {
            ...
            $('html, body').animate({
                scrollTop: $(hash).offset().top
                    - 130 // size of header and nav tabs
                    - 60 // small buffer for margin
            }, 500);
