...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="recaptchaV3.xsl"/>
    ...
    <xsl:template name="ctl-render">
        <xsl:choose>
            ...
            <xsl:when test="InputType = 'currency-v2'">
              <xsl:call-template name="ctl-currency-v2-placeholder" />
            </xsl:when>
            ...
            <xsl:when test="InputType = 'date-flatpickr'">
                <xsl:call-template name="ctl-date-flatpickr" />
            </xsl:when>
          
            <xsl:when test="InputType = 'time-flatpickr'">
              <xsl:call-template name="ctl-time-flatpickr" />
            </xsl:when>
            ...
            <xsl:when test="InputType = 'recaptchaV3'">
                <xsl:call-template name="ctl-recaptchaV3" />
            </xsl:when>
