                                    ...
                                    $.ajax({
                                        ...
                                        $("#calendar_dnn"+moduleId).fullCalendar({
                                                ...
                                                select: function (start, end) {
                                                  ...
                                                  jQuery('#dnn'+ AddPopupModuleID +'popup').modal().on('shown.bs.modal', function () {
                                                ...
                                                eventClick: function (event) {
                                                    ...
                                                    jQuery('#dnn'+ EditpopupFormModuleId +'popup').modal().on('shown.bs.modal', function () {
                                                   ...
                                                   // jQuery('#dnn' + EditpopupFormModuleId + 'root')[0].initialized = true;
                                                }
