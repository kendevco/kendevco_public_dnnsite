...
(function (angular) {
    ...
    colorPicker.directive('colorpicker', ['$document', '$compile', 'ColorHelper', '$timeout', function ($document, $compile, ColorHelper, $timeout) {
        return {
            restrict: 'A',
            scope: { colorPickerModel: '=', colorPickerOutputFormat: '=', updateField: '&' },
            ...
            link: function (scope, element, attr) {
                ...
                function keyup() {
                    $timeout(function () {
                        ...
                        scope.updateField({ field: attr.afField, val: element.val() });
                    });
                }
                ...
                scope.$on('color-changed', _.debounce(onColorChanged, 300));
                scope.$on('color-changed', function () {
                    $timeout(function () {
                        scope.update();
