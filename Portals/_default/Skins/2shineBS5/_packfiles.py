...
ROOT_FOLDER = r'C:\inetpub\KenDev\Portals\_default\Skins\2shineBS5'

FILE_TYPES = ['.ascx', '.js', '.css', '.xml', '.json', '.cshmtl', 'map', '.scss', ]
EXCLUDE_FOLDERS = ['.temp_cache', 'node_modules', '.vscode', '.git']
