...
<nav id="to-shine-page-navigation" class="navbar navbar-expand-lg bg-dark-theme">
  <div class="container">
    <a class="navbar-brand" href="<%= DotNetNuke.Common.Globals.NavigateURL(PortalController.GetCurrentPortalSettings().HomeTabId) %>" title="KenDev.Co DNN Consultant">
      <img alt="Logo" class="logo img-fluid" src="<%=SkinPath%>images/KDCO.png">
    </a>
