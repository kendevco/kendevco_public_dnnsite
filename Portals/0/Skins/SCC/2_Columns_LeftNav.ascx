...
<div class="push">
    ...
    <div class="mainContent">
        <div class="container">
            <div class="row">
                <!-- Right Pane -->
                <div class="col-md-8 col-sm-8  col-xs-12 two_col_right">
                    <%--<div class="hidden-xs">
                ...
                <!-- Left Pane -->
                <div class="col-md-4 col-sm-4  col-xs-12 two_col_left">
                    <div class="leftPane">
                        <ctl:ChildPageList runat="server" ID="ChildPageList" TopLevel="2" />
