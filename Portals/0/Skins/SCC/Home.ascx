...
<div class="push">
    ...
    <!-- Keeping You Safe Banner -->
        <div class="kys-banner-row">
            <div class="container">
                <div id="KYSBanner" runat="server"></div>
            </div>
        </div>
    ...
    <!-- Video -->
    <%--<div class="row5 vidRow">
        <div class="vidRowBorder">
            <div class="container">
                <div id="TopPane2" runat="server" class="h_TopPane2">
                </div>
            </div>
        </div>
    </div>--%>
    ...
    <div id="inquicker" runat="server" class="inquicker-container">
        </div>
    
    <!-- Bottom Left and Right Pane -->
    <div class="row-content">
        <div class="container">
            <div id="BottomLeftPane" runat="server" class="h_bottomleftpane float-left">                
            </div>
            <div id="BottomRightPane" runat="server" class="h_bottomrightpane float-right">
            </div>
        </div>
    </div>
    ...
    <%--<div class="row6">
        <div class="container">
            <div class="row">
                <!-- Left Pane -->
                <div class="col-md-8">
                    <div id="LeftPane" runat="server" class="h_LeftPane">
                    </div>
                </div>
                <!-- Right Pane -->
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-12 col-sm-6 centersNav">
                        <div id="RightTopPane" runat="server" class="h_RightTopPane">
                        </div>
                    </div>
                    <!-- Right Bottom Pane -->
                    <div class="col-md-12 col-sm-6 whyChooseNav">
                        <div id="LeftBottomPane" runat="server" class="h_RightTopPane">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <%--<div class="row7">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div id="BottomPane" runat="server" class="h_BottomPane">
                    </div>
                </div>
            </div>
        </div>
